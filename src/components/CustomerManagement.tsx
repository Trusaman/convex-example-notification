...
export function CustomerManagement({ user }: CustomerManagementProps) {
    ...
    const requestCustomerCreation = useMutation(
        api.customers.requestCustomerCreation
    );
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {customers.map((customer) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusBadge(customer.status)}`}
                                                    >
                                                        {getStatusText(
                                                            customer.status
                                                        )}
